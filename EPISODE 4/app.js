...
//what are we going to build? this ep onwards, we are building projects. The first project being a food ordering app.
//before building anything, we must make sure we have a layout or a design ready.
...
const Header = () => {
  return (
    <div id="header">
      ...
      <img className="logo"src="https://static.vecteezy.com/system/resources/previews/008/480/737/non_2x/burger-icon-simple-colored-burger-icon-fast-food-logo-free-png.png"/>
...
//restaurant card will contain image, name of restaurant, cuisines, delivery time, rating etc
//this will be injected from the swiggy api
const RestaurantCard = (props) => {
 
  const {resData} = props
  const{
    name,costForTwoString,deliveryTime,id
  } = resData.data
